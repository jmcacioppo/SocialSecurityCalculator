  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'personalinfo'], moduleId: 'aboutyou/personalinfo',
        ...
        name: 'costofliving', title: 'Cost of Living', nav: true }, { route: 'other benefits', moduleId: 'benefits/other',
...
define('text!benefits/benefits.html', ['module'], function(module) { module.exports = "<template></template>"; });
define('text!benefits/costOfLiving.html', ['module'], function(module) { module.exports = "<template></template>"; });
define('text!benefits/other.html', ['module'], function(module) { module.exports = "<template></template>"; });
define('text!results/results.html', ['module'], function(module) { module.exports = "<template></template>"; });
