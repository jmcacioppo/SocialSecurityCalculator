...
define('aboutyou/personalinfo',['exports', 'jquery', 'bootstrap-toggle', 'ion-rangeslider', 'aurelia-framework', '../services/userdata', 'jquery-ui-dist', 'src/services/constants.js'], function (exports, _jquery, _bootstrapToggle, _ionRangeslider, _aureliaFramework, _userdata) {
    ...
    var personalinfo = exports.personalinfo = (_dec = (0, _aureliaFramework.inject)(_userdata.UserData), _dec(_class = function () {
        ...
        personalinfo.prototype.calculate = function calculate() {
            ...
            if (sal > 0) {
                projectedSal[wagePerc.length - 1] = sal;
                for (var i = wagePerc.length - 2; i >= 0; i--) {
                    projectedSal[i] = projectedSal[i + 1] - projectedSal[i + 1] * wagePerc[i + 1];
                    if (projectedSal[i] > allowedSalary[i]) {
