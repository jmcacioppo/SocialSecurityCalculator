...
=======
define('aboutyou/personalinfo',['exports', 'jquery', 'bootstrap-toggle', 'src/services/constants.js', 'aurelia-framework', '../services/userdata', 'aurelia-router', 'jquery-ui-dist'], function (exports, _jquery, _bootstrapToggle, _constants, _aureliaFramework, _userdata, _aureliaRouter) {
>>>>>>> 8e56b7a20ada0dd5297ea72539888495c8ab9274
    'use strict';
    ...
    var personalinfo = exports.personalinfo = (_dec = (0, _aureliaFramework.inject)(_userdata.UserData, _aureliaRouter.Router), _dec(_class = function () {
        ...
        personalinfo.prototype.calculate = function calculate() {
            ...
            if (sal > 0) {
                projectedSal[_constants.wagePerc.length - 1] = sal;
                for (var i = _constants.wagePerc.length - 2; i >= 0; i--) {
                    projectedSal[i] = projectedSal[i + 1] - projectedSal[i + 1] * _constants.wagePerc[i + 1];
                    if (projectedSal[i] > _constants.allowedSalary[i]) {
                        inflationAdjusted[i] = _constants.allowedSalary[i] * _constants.inflationIndex[i];
                    } else {
                        inflationAdjusted[i] = projectedSal[i] * _constants.inflationIndex[i];
                    }
                }
                ...
                if (pia > _constants.consttier1) {
                    tier1 = _constants.consttier1 * _constants.tier1perc;
                } else tier1 = pia * _constants.tier1perc;
